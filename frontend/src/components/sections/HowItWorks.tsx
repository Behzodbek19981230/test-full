        ...
        <div ref={stepsRef} className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 relative">
          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <h3 className="text-[13px] sm:text-base font-bold text-slate-900 mb-1 sm:mb-2">{s.title}</h3>
              <p className="text-[11px] sm:text-sm text-slate-600 leading-relaxed max-w-[220px] mx-auto">{s.desc}</p>
            </div>
          ))}
        </div>
      </Container>
