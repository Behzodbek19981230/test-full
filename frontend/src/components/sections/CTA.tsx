...
export default function CTA() {
	return (
		<section className='py-24'>
			<Container>
				<div className='relative bg-gradient-to-br from-primary to-primary-dark rounded-3xl py-[72px] px-12 text-center border-0 overflow-hidden'>
					...
					<div className='relative z-10'>
						<h2 className='text-[38px] font-extrabold tracking-tight text-white mb-4 max-sm:text-[28px]'>
							Hoziroq Tayyorlanishni Boshlang!
						</h2>
						<p className='text-[17px] text-white/80 max-w-[480px] mx-auto mb-9 leading-relaxed'>
