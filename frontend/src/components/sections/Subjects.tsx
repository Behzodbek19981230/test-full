	...
	return (
		<section className='py-24' id='fanlar'>
				...
				<div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4'>
					{subjects.map((s) => (
						<button
							...
							className='group bg-white border border-slate-200 shadow-sm rounded-2xl p-6 flex flex-col items-center text-center transition-all duration-300 hover:border-primary/30 hover:-translate-y-1 hover:shadow-lg relative overflow-hidden cursor-pointer'
						>
							<div className='absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
							<SubjectIcon icon={s.icon} size={48} />
							<h3 className='relative text-base font-bold text-slate-900 mb-2 leading-snug'>{s.name}</h3>
						</button>
					))}
			...
			{selected && (
				...
				>
					<div
						className='bg-white border border-slate-200 shadow-2xl rounded-3xl w-full max-w-md p-0 animate-[slideUp_0.2s_ease-out]'
					...
					>
						...
						<div className='p-5 space-y-3'>
							...
							<Link
								...
								className='flex items-center gap-4 p-4 rounded-2xl border border-slate-200 bg-slate-50 hover:border-primary/30 hover:bg-primary/[0.04] transition-all group'
								onClick={() => setSelected(null)}
							>
								...
								<div className='flex-1'>
									<h4 className='text-[15px] font-bold text-slate-900'>Online test</h4>
							...
							<button
								...
								className='w-full flex items-center gap-4 p-4 rounded-2xl border border-slate-200 bg-slate-50 hover:border-secondary/30 hover:bg-secondary/[0.04] transition-all group text-left'
							>
								...
								<div className='flex-1'>
									<h4 className='text-[15px] font-bold text-slate-900'>Bot orqali yechaman</h4>
									<p className='text-[13px] text-slate-500'>
