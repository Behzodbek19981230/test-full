	...
	return (
		<section className='py-24' id='fanlar'>
			...
			{selected && (
				...
				>
					<div
						className='bg-dark-800 border border-white/[0.06] rounded-3xl w-full max-w-md p-0 animate-[slideUp_0.2s_ease-out]'
					...
					>
						...
						<div className='flex items-center justify-between p-5 border-b border-white/[0.06]'>
							...
							<button
								onClick={() => setSelected(null)}
								className='w-8 h-8 flex items-center justify-center rounded-lg text-slate-500 hover:text-slate-100 hover:bg-white/5 transition-all'
							>
								<IconX size={18} />
							</button>
						</div>
						...
						<div className='p-5 space-y-3'>
							...
							>
								...
								<span className='text-slate-600 group-hover:text-primary-light transition-colors'>
									→
								</span>
							</Link>
							...
							<button
								...
								className='w-full flex items-center gap-4 p-4 rounded-2xl border border-white/[0.06] bg-white/[0.02] hover:border-secondary/30 hover:bg-secondary/[0.04] transition-all group text-left'
							>
								...
								<div className='flex-1'>
									<h4 className='text-[15px] font-bold text-slate-50'>Bot orqali yechaman</h4>
									<p className='text-[13px] text-slate-500'>
